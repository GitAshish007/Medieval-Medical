...
<form method="post"
      action="https://newup.sigmaitsoftwares.com/medieval/EndoscopicAccessoriesReprocessorsUltrasonic.aspx" id="form1">
    <div class="aspNetHidden">
        <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
               value="/wEPDwUKMTY1NDU2MTA1MmRkN0z8pmFxhHqW6EEBzzTbU6Nxed02C9LRJggxsWzBsws="/>
    </div>

    <div class="aspNetHidden">

        <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="C4E74B0C"/>
    </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-2 text-lg-start text-center">
                        <div class="col col-lg-12">
                            <div class="d-flex flex-column">
                                ...
                                <h3 class="text-black font-1 lh-1 fw-semibold">Endoscopic Accessories Reprocessors &
                                    Ultrasonic Products</h3>
                            </div>
                        </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-3 text-center">
                        ...
                        <div class="col mb-3">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/EndoUltra.png" class="card-img-top rounded-3" alt="...">
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">EndoUltra</h5>

                                    <p class="text-gray">Inner Tank and Body Stainless steel 304 Grade</p>
                                    <p>&nbsp;</p>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button" href="EndoUltra.html"
...
<!-- Mirrored from newup.sigmaitsoftwares.com/medieval/EndoscopicAccessoriesReprocessorsUltrasonic.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 17:01:46 GMT -->
</html>

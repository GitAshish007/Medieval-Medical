...
<form method="post" action="https://newup.sigmaitsoftwares.com/medieval/AnaesthesiaWorkstation.aspx" id="form1">
    <div class="aspNetHidden">
        <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
               value="/wEPDwUKMTY1NDU2MTA1MmRkYEQ9EtosoUlo5L8ldHMeABByo6J73d8IS3jCewvbD4E="/>
    </div>

    <div class="aspNetHidden">

        <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="1DA56FBB"/>
    </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-2 text-lg-start text-center">
                        <div class="col col-lg-12">
                            <div class="d-flex flex-column">
                                <h6 class="accent-color font-2 ">Company: Siare </h6>
                                <h3 class="text-black font-1 lh-1 fw-semibold">Anaesthesia Workstation </h3>
                            </div>
                        </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-3 text-center">
                        <div class="col mb-3 dflex">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/MORPHEUS-ND.png" class="card-img-top rounded-3" alt="...">
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">MORPHEUS ND</h5>

                                    <p class="text-gray">The MORPHEUS ND represents a real innovation in the field of
                                        anesthesia.</p>
                                    <p>&nbsp;</p>
                                    <p>&nbsp;</p>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button" href="Morpheus-Nd.html"
                        ...
                        <div class="col mb-3 dflex">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/MORPHEUS-M.png" class="card-img-top rounded-3" alt="...">
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">MORPHEUS M</h5>

                                    <p class="text-gray">The MORPHEUS M is an anaesthesia machine and it can be used on
                                        adult, children and newborn patients.</p>
                                    <p>&nbsp;</p>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button" href="MorpheusM.html"
                                           class=" post-button font-2 d-flex flex-row align-items-center gap-2">Know
                                            More</a>
                                    </div>
                                </div>
...
<!-- Mirrored from newup.sigmaitsoftwares.com/medieval/AnaesthesiaWorkstation.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 17:02:10 GMT -->
</html>

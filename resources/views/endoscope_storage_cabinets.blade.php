...
<form method="post" action="https://newup.sigmaitsoftwares.com/medieval/EndoscopeStorageCabinets.aspx" id="form1">
    <div class="aspNetHidden">
        <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
               value="/wEPDwUKMTY1NDU2MTA1MmRkuX0vExa3etp7kilcNBwJFJCg7inkZCQ/JMG/KpxrQ2I="/>
    </div>

    <div class="aspNetHidden">

        <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="4C706476"/>
    </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-2 text-lg-start text-center">
                        <div class="col col-lg-12">
                            <div class="d-flex flex-column">
                                ...
                                <h3 class="text-black font-1 lh-1 fw-semibold">Endoscope Storage Cabinets Products</h3>
                            </div>
                        </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-3 text-center">
                        <div class="col mb-3">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/uniq.png" class="card-img-top rounded-3" alt="...">
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">ENDORO Uniq</h5>

                                    <p class="text-gray">08 Endoscopes Drying & Storage Cabinet</p>
                                    <p>&nbsp;</p>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button" href="Endoro-Uniq.html"
                        ...
                        <div class="col mb-3">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/Mark.png" class="card-img-top rounded-3" alt="...">
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">ENDORO Mark</h5>

                                    <p class="text-gray">08 Endoscope Drying & Storage Cabinet</p>
                                    <p>&nbsp;</p>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button" href="Endoro-Mark.html"
                                           class=" post-button font-2 d-flex flex-row align-items-center gap-2">Know
                                            More</a>
                                    </div>
                                </div>
                        ...
                        <div class="col mb-3">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/Prime.png" class="card-img-top rounded-3" alt="...">
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">ENDORO Prime</h5>
                                    ...
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button" href="Endoro-Prime.html"
                                           class=" post-button font-2 d-flex flex-row align-items-center gap-2">Know
                                            More</a>
                                    </div>
                                </div>
...
<!-- Mirrored from newup.sigmaitsoftwares.com/medieval/EndoscopeStorageCabinets.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 17:01:46 GMT -->
</html>

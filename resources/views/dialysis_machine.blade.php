...
<form method="post" action="https://newup.sigmaitsoftwares.com/medieval/DialysisMachine.aspx" id="form1">
    <div class="aspNetHidden">
        <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
               value="/wEPDwUKMTY1NDU2MTA1MmRkXecuGgrI0AHJDI8Deg6Nr0PFo7ZmHjPnYuf+sDLYkvA="/>
    </div>

    <div class="aspNetHidden">

        <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="10B8D248"/>
    </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-2 text-lg-start text-center">
                        <div class="col col-lg-12">
                            <div class="d-flex flex-column">
                                ...
                                <h3 class="text-black font-1 lh-1 fw-semibold">Dialysis Machine</h3>
                            </div>
                        </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-3 text-center">
                        <div class="col mb-3">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/EasilySwitchBetweenTherapies.png" class="card-img-top rounded-3"
                                     alt="...">
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">Baxter | Easily Switch Between Therapies</h5>

                                    <p class="text-gray">PRISMAX and PRISMAFLEX Systems deliver multiple modes of
                                    ...
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button" href="Baxter-Easily-Switch-Between-Therapies.html"
...
<!-- Mirrored from newup.sigmaitsoftwares.com/medieval/DialysisMachine.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 17:02:11 GMT -->
</html>

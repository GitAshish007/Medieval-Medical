...
<form method="post"
      action="https://newup.sigmaitsoftwares.com/medieval/Non_InvasiveHepaticEncephlopathy_DetectionDevice.aspx"
      id="form1">
    <div class="aspNetHidden">
        <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
               value="/wEPDwUKMTY1NDU2MTA1MmRkY39xiLgu47pmhiDbUOMmnDQ8VbXc9IAbVrgzFiiW34w="/>
    </div>

    <div class="aspNetHidden">

        <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="574EB14D"/>
    </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-2 text-lg-start text-center">
                        <div class="col col-lg-12">
                            <div class="d-flex flex-column">
                                <h6 class="accent-color font-2 ">Company: Hepabuddy </h6>
                                <h3 class="text-black font-1 lh-1 fw-semibold">Non - Invasive Hepatic Encephlopathy
                                    Detection Devicey</h3>
                            </div>
                        </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-3 text-center">
                        <div class="col mb-3">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/Non_InvasiveHepaticEncephlopathy_DetectionDevice.jpg"
                                     class="card-img-top rounded-3" alt="...">
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">Non - Invasive Hepatic Encephlopathy Detection
                                        Device</h5>
                                    <p>&nbsp;</p>
...
<!-- Mirrored from newup.sigmaitsoftwares.com/medieval/Non_InvasiveHepaticEncephlopathy_DetectionDevice.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 17:01:56 GMT -->
</html>

...
<form method="post" action="https://newup.sigmaitsoftwares.com/medieval/HyperLightDisinfectionRobot.aspx" id="form1">
    <div class="aspNetHidden">
        <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
               value="/wEPDwUKMTY1NDU2MTA1MmRkaC0VeO4iIKlFmkH8yJRipPSEYFfVXlKuzgjSeHL8U1o="/>
    </div>

    <div class="aspNetHidden">

        <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="E2601D6B"/>
    </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-2 text-lg-start text-center">
                        <div class="col col-lg-12">
                            <div class="d-flex flex-column">
                                ...
                                <h3 class="text-black font-1 lh-1 fw-semibold">Disinfection Robot</h3>
                            </div>
                        </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-3 text-center">
                        ...
                        <div class="col mb-3">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/robotlight.png" class="card-img-top rounded-3" alt="...">
                                <div class="card-body ">

                                    <h5 class="font-1 fw-bold">Hyper Light Disinfection Robot</h5>
                                    ...
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button" href="Hyper_Light_Disinfection.html"
...
<!-- Mirrored from newup.sigmaitsoftwares.com/medieval/HyperLightDisinfectionRobot.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 17:02:44 GMT -->
</html>

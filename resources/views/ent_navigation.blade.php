...
<form method="post" action="https://newup.sigmaitsoftwares.com/medieval/ENT-Navigation.aspx" id="form1">
    <div class="aspNetHidden">
        <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
               value="/wEPDwUKMTY1NDU2MTA1MmRkjYfl2Wq6BvKgS3xY3vhpygkQOINCA8Bx0uhVIwbvSGs="/>
    </div>

    <div class="aspNetHidden">

        <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="50093B68"/>
    </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-2 text-lg-start text-center">
                        <div class="col col-lg-12">
                            <div class="d-flex flex-column">
                                ...
                                <h3 class="text-black font-1 lh-1 fw-semibold">ENT Navigation</h3>
                            </div>
                        </div>
...
<!-- Mirrored from newup.sigmaitsoftwares.com/medieval/ENT-Navigation.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 17:02:27 GMT -->
</html>

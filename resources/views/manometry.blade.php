...
<form method="post" action="https://newup.sigmaitsoftwares.com/medieval/Manometry.aspx" id="form1">
    <div class="aspNetHidden">
        <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
               value="/wEPDwUKMTY1NDU2MTA1MmRk9BmD7d+Z77IORow6qt2fUG9EV5+nYnORYwliBO3HeEs="/>
    </div>

    <div class="aspNetHidden">

        <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="F8ABEE46"/>
    </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-2 text-lg-start text-center">
                        <div class="col col-lg-12">
                            <div class="d-flex flex-column">
                                <h6 class="accent-color font-2 ">Company: Diversatek </h6>
                                <h3 class="text-black font-1 lh-1 fw-semibold">Manometry</h3>
                            </div>
                        </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-3 text-center">
                        ...
                        <div class="col mb-3 dflex">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/HRiM.png" class="card-img-top rounded-3" alt="...">
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">HRiM High Resolution Impedance Manometry</h5>

                                    <p class="text-gray">In one simple swallow test, the inSIGHT Ultima System
                                        accurately assesses esophageal function by combining bolus transit dynamics and
                                        muscular activity.</p>
                                    <p>&nbsp;</p>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button" href="HRiM-High-Resolution-Impedance-Manometry.html"
                        ...
                        <div class="col mb-3 dflex">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/Diversatek.png" class="card-img-top rounded-3" alt="...">
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">The Diversatek Healthcare Pelvic Floor Evaluation and
                                        Retraining System</h5>

                                    <p class="text-gray">Diversatek Healthcare has developed a comprehensive product
                                        portfolio for Pelvic Floor Evaluation. </p>
                                    <p>&nbsp;</p>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button"
                                           href="Th-%20Diversatek-Healthcare-Pelvic-Floor-Evaluation-and-Retraining-System.html"
                                           class=" post-button font-2 d-flex flex-row align-items-center gap-2">Know
                                            More </a>
                                    </div>
                                </div>
...
<!-- Mirrored from newup.sigmaitsoftwares.com/medieval/Manometry.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 17:01:56 GMT -->
</html>

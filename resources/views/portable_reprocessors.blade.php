...
<form method="post" action="https://newup.sigmaitsoftwares.com/medieval/PortableReprocessorsforEndoscopes.aspx"
      id="form1">
    <div class="aspNetHidden">
        <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
               value="/wEPDwUKMTY1NDU2MTA1MmRk8Hyq3oTpV/3XhoSty0Tfjgs8bPKPN6KXMFYuQGoa20E="/>
    </div>

    <div class="aspNetHidden">

        <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="5205429A"/>
    </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-2 text-lg-start text-center">
                        <div class="col col-lg-12">
                            <div class="d-flex flex-column">
                                ...
                                <h3 class="text-black font-1 lh-1 fw-semibold">Portable Reprocessors for Endoscopes</h3>
                            </div>
                        </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-3 text-center">
                        ...
                        <div class="col mb-3">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                ...
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">EndoJet</h5>

                                    <p class="text-gray">Lcd display showing set time and down time of working cycle
                                        mode.</p>
                                    <p>&nbsp;</p>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button" href="EndoJet.html"
...
<!-- Mirrored from newup.sigmaitsoftwares.com/medieval/PortableReprocessorsforEndoscopes.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 17:01:49 GMT -->
</html>

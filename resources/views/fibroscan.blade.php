...
<form method="post" action="https://newup.sigmaitsoftwares.com/medieval/Fibroscan.aspx" id="form1">
    <div class="aspNetHidden">
        <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
               value="/wEPDwUKMTY1NDU2MTA1MmRkyljyME5zAcnmegoA+YxFKfrB+AMcfmXUSAK7eYIT5+U="/>
    </div>

    <div class="aspNetHidden">

        <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="2E52BEEA"/>
    </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-2 text-lg-start text-center">
                        <div class="col col-lg-12">
                            <div class="d-flex flex-column">
                                <h6 class="accent-color font-2 ">Cpmpany: Echosens </h6>
                                <h3 class="text-black font-1 lh-1 fw-semibold">Fibroscan Products</h3>
                            </div>
                        </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-3 text-center">
                        <div class="col mb-3 dflex">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/f_p1.png" class="card-img-top rounded-3" alt="...">
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">FibroScan® Mini+ 430</h5>

                                    <p class="text-gray">The mobile non-invasive solution for liver disease management,
                                        ideal for multi-site configuration</p>
                                    <p>&nbsp;</p>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button" href="FibroScan_Mini430.html"
                        ...
                        <div class="col mb-3 dflex">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/f_p2.png" class="card-img-top rounded-3" alt="...">
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">FibroScan® Compact 530</h5>

                                    <p class="text-gray">The portable non-invasive solution for efficient liver disease
                                        <br/> Management.</p>
                                    <p>&nbsp;</p>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button" href="FibroScan-Compact-530.html"
                                           class=" post-button font-2 d-flex flex-row align-items-center gap-2">Know
                                            More</a>
                                    </div>
                                </div>
                        ...
                        <div class="col mb-3 dflex">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/f_p3.png" class="card-img-top rounded-3" alt="...">
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">FibroScan® Expert 630</h5>

                                    <p class="text-gray">The complete non-invasive solution for advanced liver disease
                                        <br/> Management.</p>
                                    <p>&nbsp;</p>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button" href="FibroScanExpert%20630.html"
                                           class=" post-button font-2 d-flex flex-row align-items-center gap-2">Know
                                            More</a>
                                    </div>
                                </div>
...
<!-- Mirrored from newup.sigmaitsoftwares.com/medieval/Fibroscan.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 17:01:43 GMT -->
</html>

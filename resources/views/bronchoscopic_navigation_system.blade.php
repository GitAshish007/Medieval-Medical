...
<form method="post" action="https://newup.sigmaitsoftwares.com/medieval/Bronchoscopic-Navigation-System.aspx"
      id="form1">
    <div class="aspNetHidden">
        <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
               value="/wEPDwUKMTY1NDU2MTA1MmRkJl3fkv4wzvficvDFWADrMQ5hvL8YV7Vl855zWl7ettg="/>
    </div>

    <div class="aspNetHidden">

        <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="F20C4055"/>
    </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-2 text-lg-start text-center">
                        <div class="col col-lg-12">
                            <div class="d-flex flex-column">
                                <h6 class="accent-color font-2 "> Company : Broncus</h6>
                                <h3 class="text-black font-1 lh-1 fw-semibold">Bronchoscopic Navigation System</h3>
                            </div>
                        </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-3 text-center">
                        <div class="col mb-3">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/LungPro.png" class="card-img-top rounded-3" alt="...">
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">LungPro</h5>
                                    ...
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button" href="LungPro.html"
                        ...
                        <div class="col mb-3">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/LungPoint.png" class="card-img-top rounded-3" alt="...">
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">LungPoint</h5>
                                    ...
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button" href="LungPoint.html"
                                           class=" post-button font-2 d-flex flex-row align-items-center gap-2">Know
                                            More</a>
                                    </div>
                                </div>
                        ...
                        <div class="col mb-3">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/LungPointPlus.png" class="card-img-top rounded-3" alt="...">
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">LungPoint Plus</h5>
                                    ...
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button" href="LungPoint-Plus.html"
                                           class=" post-button font-2 d-flex flex-row align-items-center gap-2">Know
                                            More</a>
                                    </div>
                                </div>
...
<!-- Mirrored from newup.sigmaitsoftwares.com/medieval/Bronchoscopic-Navigation-System.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 17:02:19 GMT -->
</html>

...
<form method="post" action="https://newup.sigmaitsoftwares.com/medieval/ReprocessingAreaSolutions.aspx" id="form1">
    <div class="aspNetHidden">
        <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
               value="/wEPDwUKMTY1NDU2MTA1MmRkWpSkAzEUSg3BbMfmJi8S/Wf+TQ+JzKNOyylfXYuK2Fk="/>
    </div>

    <div class="aspNetHidden">

        <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="E0705105"/>
    </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-2 text-lg-start text-center">
                        <div class="col col-lg-12">
                            <div class="d-flex flex-column">
                                ...
                                <h3 class="text-black font-1 lh-1 fw-semibold">Reprocessing Area Solutions</h3>
                            </div>
                        </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-3 text-center">
                        ...
                        <div class="col mb-3">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/commingsoon.png" class="card-img-top rounded-3" alt="...">
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">Reprocessing Area Solutions</h5>

                                    <p class="text-gray">providing Customized solutions for Manual Reprocessing stations
                                        of Endoscopes & medical Devices as one stop shop for our clients.</p>
                                    <p>&nbsp;</p>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button" href="Reprocessing-Area-Solutions.html"
                                           class=" post-button font-2 d-flex flex-row align-items-center gap-2">Coming
                                            Soon</a>
                                    </div>
                                </div>
                            </div>
...
<!-- Mirrored from newup.sigmaitsoftwares.com/medieval/ReprocessingAreaSolutions.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 17:01:48 GMT -->
</html>

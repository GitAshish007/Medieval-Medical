...
<form method="post" action="https://newup.sigmaitsoftwares.com/medieval/Auto-CPR-Machine.aspx" id="form1">
    <div class="aspNetHidden">
        <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
               value="/wEPDwUKMTY1NDU2MTA1MmRkU8/6cKy/mtES1lgFV0r1qUZsvNkBxDsGHnfS4AABAW4="/>
    </div>

    <div class="aspNetHidden">

        <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="3AF48B77"/>
    </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-2 text-lg-start text-center">
                        <div class="col col-lg-12">
                            <div class="d-flex flex-column">
                                <h6 class="accent-color font-2 ">Company: Amoul </h6>
                                <h3 class="text-black font-1 lh-1 fw-semibold">Auto CPR Machine </h3>
                            </div>
                        </div>
                    ...
                    <div class="row row-cols-1 row-cols-lg-3 text-center">
                        <div class="col mb-3">
                            <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                                <img src="image/CardiopulmonaryResuscitator-e8.png" class="card-img-top rounded-3"
                                     alt="...">
                                <div class="card-body ">
                                    <h5 class="font-1 fw-bold">Amoul | Cardiopulmonary Resuscitator E8</h5>

                                    <p class="text-gray">Clinically proven to improve the efficiency of cardiopulmonary
                                        resuscitation.</p>
                                    <p>&nbsp;</p>
                                    <p>&nbsp;</p>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a type="button" href="Amoul-Cardiopulmonary-Resuscitator-E8.html"
...
<!-- Mirrored from newup.sigmaitsoftwares.com/medieval/Auto-CPR-Machine.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 17:02:11 GMT -->
</html>
